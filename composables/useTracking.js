...
// Retired: social_proof_counter (rolled back 2026-09-19, lost on desktop).
const ACTIVE_EXPERIMENTS = [];

// Read a variant from localStorage WITHOUT assigning one. This keeps
// non-enrolled users (e.g. mobile visitors for a desktop-only test) from
// getting a stray variants_json entry every time they fire an event.
